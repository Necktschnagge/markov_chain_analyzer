...
struct sc {
	...
	inline static const auto time_total_create_pto_matrix{ std::string("time_total_create_pto_matrix") };
	inline static const auto time_total_copy_pto_matrix{ std::string("time_total_copy_pto_matrix") };
